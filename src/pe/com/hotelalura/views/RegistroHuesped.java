...
import pe.com.hotelalura.utils.Exito;
import pe.com.hotelalura.utils.Nacionalidad;
...
public class RegistroHuesped extends JFrame {
	...
	private HuespedController controlHuesped;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JFrame frame = new RegistroHuesped(0);
	...
	public RegistroHuesped(int idReserva) {
		...
		txtNacionalidad.setModel(new DefaultComboBoxModel(Nacionalidad.values()));
		...
		lblTitulo.setBounds(541, 50, 274, 42);
