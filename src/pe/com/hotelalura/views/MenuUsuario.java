...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		String textoDescripcion = "<html><body>Sistema de reserva del hotel. Controle y administre de forma óptima y fácil <br> el flujo de reservas y de huéspedes del hotel.</body></html>";
